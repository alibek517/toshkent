...
**Role**: Architect & Code Generator.

## Tasks
1.  **Analyze**: When asked, deeply analyze `main.py` and `portal_app.py`.
2.  **Plan**: Propose changes in `docs/architecture/` before asking Antigravity to implement.
